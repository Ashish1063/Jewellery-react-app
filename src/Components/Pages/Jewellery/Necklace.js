...
const Necklace = () => {
    return (
        <div className='Jewellery Necklace'>
            <div className="jewelleryTop">
                ...
                <div className="col-12 d-flex  flex-wrap">
                    ...
                    <div className="col-md-8 right">
                        <img src={require('../../Images/Jewellery/jewelleryBannerImg.png')} alt="" />
                    </div>
                </div>
                ...
                <div className="Category">
                    <ul className="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        <li className="nav-item" role="presentation">
                            <a className="nav-link active" id="pills-1-tab" data-toggle="pill" href="#pills-1" role="tab" aria-controls="pills-1" aria-selected="true">Collar Necklace</a>
                        </li>
                        <li className="nav-item" role="presentation">
                            <a className="nav-link" id="pills-2-tab" data-toggle="pill" href="#pills-2" role="tab" aria-controls="pills-2" aria-selected="false">Charm Necklace</a>
                        </li>
                        <li className="nav-item" role="presentation">
                            <a className="nav-link" id="pills-3-tab" data-toggle="pill" href="#pills-3" role="tab" aria-controls="pills-3" aria-selected="false">Choker</a>
                        </li>
                        <li className="nav-item" role="presentation">
                            <a className="nav-link" id="pills-4-tab" data-toggle="pill" href="#pills-4" role="tab" aria-controls="pills-4" aria-selected="false">Festoon Necklace</a>
                        </li>
                        <li className="nav-item" role="presentation">
                            <a className="nav-link" id="pills-5-tab" data-toggle="pill" href="#pills-5" role="tab" aria-controls="pills-5" aria-selected="false">Princess Necklace</a>
                        </li>
                        <li className="nav-item" role="presentation">
                            <a className="nav-link" id="pills-6-tab" data-toggle="pill" href="#pills-6" role="tab" aria-controls="pills-6" aria-selected="false">Matinee Necklace</a>
                        </li>
                        <li className="nav-item" role="presentation">
                            <a className="nav-link" id="pills-7-tab" data-toggle="pill" href="#pills-7" role="tab" aria-controls="pills-7" aria-selected="false">Sautoir</a>
                        </li>
                    </ul>
                                ...
                                <div className="col-md-3 ">
                                    <div className="card card-body">
                                        <div className="cardTop">
                                            ...
                                            <img src={require("../../Images/Jewellery/Necklace/Necklace1.png")} alt="" />
                                        </div>
                                        <div className="cardBottom">
                                            <Link to='/detail'>
                                            <div className="row">
                                                <div className="col-6">
                                                    <h5 className="m-0 mb-2">Necklace</h5>
                                ...
                                <div className="col-md-3 ">
                                    <div className="card card-body">
                                        <div className="cardTop">
                                            ...
                                            <img src={require("../../Images/Jewellery/Necklace/Necklace2.png")} alt="" />
                                        </div>
                                        <div className="cardBottom">
                                            <Link to='/detail'>
                                            <div className="row">
                                ...
                                <div className="col-md-3 ">
                                    <div className="card card-body">
                                        <div className="cardTop">
                                            ...
                                            <img src={require("../../Images/Jewellery/Necklace/Necklace3.png")} alt="" />
                                        </div>
                                        <div className="cardBottom">
                                            <Link to='/detail'>
                                            <div className="row">
                                ...
                                <div className="col-md-3 ">
                                    <div className="card card-body">
                                        <div className="cardTop">
                                            ...
                                            <img src={require("../../Images/Jewellery/Necklace/Necklace4.png")} alt="" />
                                        </div>
                                        <div className="cardBottom">
                                            <Link to='/detail'>
                                            <div className="row">
