            ...
            <div className="jewelleryTop">
                ...
                <div className="col-12 d-flex  flex-wrap">
                    ...
                    <div className="col-md-8 col-lg-8 right">
                        <img src={require('../../Images/Jewellery/GiftBanner.png')} alt="" />
                    </div>
                </div>
                ...
                <div className="Category">
                    <ul className="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        <li className="nav-item" role="presentation">
                            <a className="nav-link active" id="pills-1-tab" data-toggle="pill" href="#pills-1" role="tab" aria-controls="pills-1" aria-selected="true">Anniversary Gift</a>
                        </li>
                        <li className="nav-item" role="presentation">
                            <a className="nav-link" id="pills-2-tab" data-toggle="pill" href="#pills-2" role="tab" aria-controls="pills-2" aria-selected="false">Birthday gift</a>
                        </li>
                        <li className="nav-item" role="presentation">
                            <a className="nav-link" id="pills-3-tab" data-toggle="pill" href="#pills-3" role="tab" aria-controls="pills-3" aria-selected="false">Gift for Kids & Teens</a>
                        </li>
                        <li className="nav-item" role="presentation">
                            <a className="nav-link" id="pills-6-tab" data-toggle="pill" href="#pills-6" role="tab" aria-controls="pills-6" aria-selected="false">Auspicious Occasions</a>
                        </li>
