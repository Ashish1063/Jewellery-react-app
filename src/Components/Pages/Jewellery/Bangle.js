...
const Bangle = () => {
    return (
        <div className='Jewellery Bangle'>
            <div className="jewelleryTop">
                ...
                <div className="col-12 d-flex  flex-wrap">
                    ...
                    <div className="col-md-8 right">
                        <img src={require('../../Images/Jewellery/BangleBanner.png')} alt="" />
                    </div>
                </div>
                ...
                <div className="Category">
                    <ul className="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        <li className="nav-item" role="presentation">
                            <a className="nav-link active" id="pills-1-tab" data-toggle="pill" href="#pills-1" role="tab" aria-controls="pills-1" aria-selected="true">Kids Bangle</a>
                        </li>
                        <li className="nav-item" role="presentation">
                        ...
                        <li className="nav-item" role="presentation">
                            <a className="nav-link" id="pills-6-tab" data-toggle="pill" href="#pills-6" role="tab" aria-controls="pills-6" aria-selected="false">Promise Bangle</a>
                        </li>
                        <li className="nav-item" role="presentation">
                                ...
                                <div className="col-md-3 ">
                                    <div className="card card-body">
                                        <div className="cardTop">
                                            ...
                                            <img src={require("../../Images/Jewellery/Bangle/Bangle1.png")} alt="" />
                                        </div>
                                        <div className="cardBottom">
                                            <div className="row">
                                                <div className="col-6">
                                                    <h5 className="m-0 mb-2">Bangle</h5>
                                ...
                                <div className="col-md-3 ">
                                    <div className="card card-body">
                                        <div className="cardTop">
                                            ...
                                            <img src={require("../../Images/Jewellery/Bangle/Bangle2.png")} alt="" />
                                        </div>
                                        <div className="cardBottom">
                                            <div className="row">
                                                <div className="col-6">
                                ...
                                <div className="col-md-3 ">
                                    <div className="card card-body">
                                        <div className="cardTop">
                                            ...
                                            <img src={require("../../Images/Jewellery/Bangle/Bangle3.png")} alt="" />
                                        </div>
                                        <div className="cardBottom">
                                            <div className="row">
                                                <div className="col-6">
                                ...
                                <div className="col-md-3 ">
                                    <div className="card card-body">
                                        <div className="cardTop">
                                            ...
                                            <img src={require("../../Images/Jewellery/Bangle/Bangle4.png")} alt="" />
                                        </div>
                                        <div className="cardBottom">
                                            <div className="row">
                                                <div className="col-6">
