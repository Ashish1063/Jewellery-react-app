...
const Earring = () => {
    return (
        <div className='Jewellery Earring'>
            <div className="jewelleryTop">
                ...
                <div className="col-12 d-flex  flex-wrap">
                    ...
                    <div className="col-md-8 right">
                        <img src={require('../../Images/Jewellery/EarringBanner.png')} alt="" />
                    </div>
                </div>
                ...
                <div className="Category">
                    <ul className="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        <li className="nav-item" role="presentation">
                            <a className="nav-link active" id="pills-1-tab" data-toggle="pill" href="#pills-1" role="tab" aria-controls="pills-1" aria-selected="true">Drops</a>
                        </li>
                        <li className="nav-item" role="presentation">
                            <a className="nav-link" id="pills-2-tab" data-toggle="pill" href="#pills-2" role="tab" aria-controls="pills-2" aria-selected="false">Chandbali</a>
                        </li>
                        <li className="nav-item" role="presentation">
                            <a className="nav-link" id="pills-3-tab" data-toggle="pill" href="#pills-3" role="tab" aria-controls="pills-3" aria-selected="false">Jhumkas</a>
                        </li>
                        <li className="nav-item" role="presentation">
                            <a className="nav-link" id="pills-4-tab" data-toggle="pill" href="#pills-4" role="tab" aria-controls="pills-4" aria-selected="false">Studs</a>
                        </li>
                        <li className="nav-item" role="presentation">
                            <a className="nav-link" id="pills-5-tab" data-toggle="pill" href="#pills-5" role="tab" aria-controls="pills-5" aria-selected="false">Hoops</a>
                        </li>
                        <li className="nav-item" role="presentation">
                            <a className="nav-link" id="pills-6-tab" data-toggle="pill" href="#pills-6" role="tab" aria-controls="pills-6" aria-selected="false">Hoops</a>
                        </li>
                        <li className="nav-item" role="presentation">
                            <a className="nav-link" id="pills-7-tab" data-toggle="pill" href="#pills-7" role="tab" aria-controls="pills-7" aria-selected="false">Suidhaga</a>
                        </li>
                        <li className="nav-item" role="presentation">
                            <a className="nav-link" id="pills-8-tab" data-toggle="pill" href="#pills-8" role="tab" aria-controls="pills-8" aria-selected="false">Dangler</a>
                        </li>
                    </ul>
                    <div className="tab-content" id="pills-tabContent">
                                ...
                                <div className="col-md-3 ">
                                    <div className="card card-body">
                                        <div className="cardTop">
                                            ...
                                            <img src={require("../../Images/Jewellery/Earring/Earring1.png")} alt="" />
                                        </div>
                                        <div className="cardBottom">
                                            <div className="row">
                                                <div className="col-6">
                                                   <h5 className="m-0 mb-2">Earring</h5>
                                ...
                                <div className="col-md-3 ">
                                    <div className="card card-body">
                                        <div className="cardTop">
                                            ...
                                            <img src={require("../../Images/Jewellery/Earring/Earring2.png")} alt="" />
                                        </div>
                                        <div className="cardBottom">
                                            <div className="row">
                                                <div className="col-6">
                                ...
                                <div className="col-md-3 ">
                                    <div className="card card-body">
                                        <div className="cardTop">
                                            ...
                                            <img src={require("../../Images/Jewellery/Earring/Earring3.png")} alt="" />
                                        </div>
                                        <div className="cardBottom">
                                            <div className="row">
                                                <div className="col-6">
                                ...
                                <div className="col-md-3 ">
                                    <div className="card card-body">
                                        <div className="cardTop">
                                            ...
                                            <img src={require("../../Images/Jewellery/Earring/Earring4.png")} alt="" />
                                        </div>
                                        <div className="cardBottom">
                                            <div className="row">
                                                <div className="col-6">
                        ...
                        <div className="tab-pane fade" id="pills-6" role="tabpanel" aria-labelledby="pills-6-tab">
                            <div className="row">
                                <div className="col-md-3 ">
                                    <div className="card card-body">
                                        <div className="cardTop">
                        ...
                        <div className="tab-pane fade" id="pills-7" role="tabpanel" aria-labelledby="pills-7-tab">
                            <div className="row">
                                <div className="col-md-3 ">
                                    <div className="card card-body">
                                        <div className="cardTop">
                        ...
                        <div className="tab-pane fade" id="pills-8" role="tabpanel" aria-labelledby="pills-8-tab">
                            <div className="row">
                                <div className="col-md-3 ">
                                    <div className="card card-body">
                                        <div className="cardTop">
