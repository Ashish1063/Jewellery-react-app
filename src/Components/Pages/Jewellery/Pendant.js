...
const Pendant = () => {
    return (
        <div className='Jewellery Pendant'>
            <div className="jewelleryTop">
                ...
                <div className="col-12 d-flex  flex-wrap">
                    ...
                    <div className="col-md-8 right">
                        <img src={require('../../Images/Jewellery/PendantBanner.png')} alt="" />
                    </div>
                </div>
                ...
                <div className="Category">
                    <ul className="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        <li className="nav-item" role="presentation">
                            <a className="nav-link active" id="pills-1-tab" data-toggle="pill" href="#pills-1" role="tab" aria-controls="pills-1" aria-selected="true">Religious</a>
                        </li>
                        <li className="nav-item" role="presentation">
                            <a className="nav-link" id="pills-2-tab" data-toggle="pill" href="#pills-2" role="tab" aria-controls="pills-2" aria-selected="false">Heart</a>
                        </li>
                        <li className="nav-item" role="presentation">
                            <a className="nav-link" id="pills-3-tab" data-toggle="pill" href="#pills-3" role="tab" aria-controls="pills-3" aria-selected="false">Alphabet</a>
                        </li>
                        <li className="nav-item" role="presentation">
                            <a className="nav-link" id="pills-4-tab" data-toggle="pill" href="#pills-4" role="tab" aria-controls="pills-4" aria-selected="false">Floral</a>
                        </li>
                        <li className="nav-item" role="presentation">
                            <a className="nav-link" id="pills-5-tab" data-toggle="pill" href="#pills-5" role="tab" aria-controls="pills-5" aria-selected="false">Fusion</a>
                        </li>
                        <li className="nav-item" role="presentation">
                            <a className="nav-link" id="pills-6-tab" data-toggle="pill" href="#pills-6" role="tab" aria-controls="pills-6" aria-selected="false">Special Occasions</a>
                        </li>
                        <li className="nav-item" role="presentation">
                            <a className="nav-link" id="pills-7-tab" data-toggle="pill" href="#pills-7" role="tab" aria-controls="pills-7" aria-selected="false">Nautre</a>
                        </li>
                    </ul>
                                ...
                                <div className="col-md-3 ">
                                    <div className="card card-body">
                                        ...
                                        <div className="cardBottom">
                                            <div className="row">
                                                <div className="col-6">
                                                     <h5 className="m-0 mb-2">Pendant</h5>
                                ...
                                <div className="col-md-3 ">
                                    <div className="card card-body">
                                        <div className="cardTop">
                                            ...
                                            <img src={require("../../Images/Jewellery/Pendant/Pendant2.png")} alt="" />
                                        </div>
                                        <div className="cardBottom">
                                            <div className="row">
                                                <div className="col-6">
                                ...
                                <div className="col-md-3 ">
                                    <div className="card card-body">
                                        <div className="cardTop">
                                            ...
                                            <img src={require("../../Images/Jewellery/Pendant/Pendant3.png")} alt="" />
                                        </div>
                                        <div className="cardBottom">
                                            <div className="row">
                                                <div className="col-6">
                                ...
                                <div className="col-md-3 ">
                                    <div className="card card-body">
                                        <div className="cardTop">
                                            ...
                                            <img src={require("../../Images/Jewellery/Pendant/Pendant4.png")} alt="" />
                                        </div>
                                        <div className="cardBottom">
                                            <div className="row">
                                                <div className="col-6">
                                ...
                                <div className="col-md-3 ">
                                    <div className="card card-body">
                                        <div className="cardTop">
                                            ...
                                            <img src={require("../../Images/Jewellery/Pendant/Pendant1.png")} alt="" />
                                        </div>
                                        <div className="cardBottom">
                                            <div className="row">
                                                <div className="col-6">
