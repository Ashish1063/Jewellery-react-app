            ...
            <div className="jewelleryTop">
                <div className="col-12 d-flex  flex-wrap ">
                    ...
                    <div className="col-md-8 col-lg-8 right">
                        <img src={require('../../Images/Jewellery/WeddingBanner.png')} alt="" />
                    </div>
                </div>
                                ...
                                <div className="col-md-3 ">
                                    <div className="card card-body">
                                        <div className="cardTop">
                                            ...
                                            <img src={require("../../Images/Jewellery/Wedding/wedding1.png")} alt="" />
                                        </div>
                                ...
                                <div className="col-md-3 ">
                                    <div className="card card-body">
                                        <div className="cardTop">
                                            ...
                                            <img src={require("../../Images/Jewellery/Wedding/wedding2.png")} alt="" />
                                        </div>
                                        <div className="cardBottom">
                                            <div className="row">
                                                <div className="col-6">
                                ...
                                <div className="col-md-3 ">
                                    <div className="card card-body">
                                        <div className="cardTop">
                                            ...
                                            <img src={require("../../Images/Jewellery/Wedding/wedding3.png")} alt="" />
                                        </div>
                                        <div className="cardBottom">
                                            <div className="row">
                                                <div className="col-6">
                                ...
                                <div className="col-md-3 ">
                                    <div className="card card-body">
                                        <div className="cardTop">
                                            ...
                                            <img src={require("../../Images/Jewellery/Wedding/wedding4.png")} alt="" />
                                        </div>
                                        <div className="cardBottom">
                                            <div className="row">
                                                <div className="col-6">
